...
from .views import (index, contact_view, dashboard_view, profile_settings_view, faq,
                    profile_view, plan_detail_view, send_payment_review, 
                    plans_view,deposit_view,send_deposit_review,transaction_view,deposits_view,search_view,withdraw_view,withdrawal_view,pricing,about,referral_view)
