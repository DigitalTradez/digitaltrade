...
def send_confirmation_email(request, user):
    ...
    confirmation_link = f'https://digitaltradez.com/confirm-email/{token}/'
    email_data = {
                "from": "digitaltradez <noreply@digitaltradez.com>",
                "to": recipient,
        ...
        <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
          <tbody>
            <tr>
              ...
              <img src="https://digitaltradez.com/static/logo/logo-7.png" style="border-radius: 15px;" height="200"/>
                </td>
            </tr>
            ...
            <tr>
              ...
              Thanks for signing up for <span class="il">DigitalTradez! </span><br> We're so excited to have you onboard.</td>
            </tr>
            <tr>
              <td valign="top" align="left" style="font-family:Roboto,Helvetica,Arial sans-serif;font-size:14px;line-height:24px;color:#414347;padding:40px 40px 20px 40px">
            ...
            <tr>
              <td valign="top" align="center" style="font-family:Roboto,Helvetica,Arial sans-serif;font-size:14px;line-height:24px;color:#414347;padding:10px 40px 40px 40px">
                <a href="https://digitaltradez.com">digitaltradez.com</a></td>
            </tr>
...
def reset_password(request, user):
    ...
    # Compose the email message
    recipient = user.email
    reset_link = f'https://digitaltradez.com/reset-password/{token}/'
    email_data = {
                "from": "digitaltradez <noreply@digitaltradez.com>",
                "to": recipient,
        ...
        <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
          <tbody>
            ...
            <tr>
              <td valign="top" align="left" style="font-family:Roboto,Helvetica,Arial sans-serif;font-size:14px;line-height:24px;color:#414347;padding:40px 40px 20px 40px">
              You requested a password reset on your<br> digitaltradez account.</td>
            </tr>
            <tr>
              <td valign="top" align="left" style="font-family:Roboto,Helvetica,Arial sans-serif;font-size:14px;line-height:24px;color:#414347;padding:40px 40px 20px 40px">
