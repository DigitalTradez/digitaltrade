                    ...
                    "html": f"""
                        ...
                        <body>
                            <div class="container">
                                ...
                                <p>If you have any questions or if there's anything we can assist you with, please feel free to reach out to our customer support team at <a href="mailto:support@digitaltradez.com">support@digitaltradez.com</a>. We are here to help and provide any information you may need</p>
                                <p>Once again, thank you for choosing digitaltradez. We look forward to a prosperous and successful investment journey together.</p><br><br>
                                <div style="text-align: center; align-items: center;">
                                    <a href="https://digitaltradez.com/app/dashboard" class="btn btn-primary" style="background-color: #007bff; font-size: 16px; border-color: #007bff; padding: 10px 20px; color: #fff; border-radius: 2px;" target="_blank">Dashboard</a><br><br>
                                </div>
                ...
                "html": f"""
                    ...
                    <body>
                        <div class="container">
                            ...
                            <div style="text-align: center; align-items: center;">
                                <a href="https://digitaltradez.com/app/dashboard" class="btn btn-primary" style="background-color: #007bff; font-size: 16px; border-color: #007bff; padding: 10px 20px; border-radius: 2px;" target="_blank">View Dashboard</a><br><br>
                            </div>
                            <p style="margin-top: 20px; font-size: 12px; color: #666666;">
                                Note: This email is sent as part of digitaltradez communication. If you believe this is a mistake or received this email in error, please disregard it.
                            </p>
                        </div>
